...
public static unsafe class CStrings
{
    ...
    public static CString* CStringArrayP(ReadOnlySpan<string> values)
    {
        var result = (CString*)Marshal.AllocHGlobal(IntPtr.Size * values.Length);
    ...
    /// <param name="values">The strings.</param>
    /// <returns>An array pointer of C string pointers. You are responsible for freeing the returned pointer.</returns>
    public static CStringWide* CStringWideArray(this ReadOnlySpan<string> values)
    {
        var result = (CStringWide*)Marshal.AllocHGlobal(IntPtr.Size * values.Length);
